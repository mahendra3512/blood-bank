...
<!-- ******************************************************************************************* -->
<!--<form name="myForm" action="blood_donor.php" method="post">
		...
		<div class = "panel panel-danger">
			<div class = "panel-heading">
				<h3 class = "panel-title">
					Blood Donor Questionnaire & Consent Form
				</h3>
			</div>
		...
		<div class = "panel-body">
			<div class="row">
				...
				<div class="col-md-4">
					...
					<input id="d_date" name="d_date" class="form-control" type="date" required=""/>
					<br>
				</div>
