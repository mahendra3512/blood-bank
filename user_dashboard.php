 ...
 <header><br>
        <nav class="container">
            ...
            <div class="nav-links">
                ...
                &nbsp;
                <a href="view_donation.php">Available donors</a>
				&nbsp;
...
<section id="hero">
        <div class="hero-content">
            <div class="hero-text">
                ...
                <a href="blood_donor_req.php" class="cta-button"> Donate Blood</a>&nbsp;
				<a href="BloodReceiver.php" class="cta-button">Blood Recipient</a><br><br>
				<a href="organ_donor_req.php" class="cta-button"> Donate Organ</a>
			&nbsp;<a href="organ_requirement.form.php" class="cta-button"> Organ Recipient</a>
            </div>
